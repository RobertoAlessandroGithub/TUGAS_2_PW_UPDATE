     ...
     <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  action = "{{route ('mahasiswa.update', $mahasiswa->id)}}" enctype="multipart/form-data">
                  @csrf
                  @method('patch')
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="tempat_lahir" placeholder="Kota Mahasiswa" value="{{$mahasiswa->tempat_lahir}}">
                      @error('tempat_lahir')
                      <label closs="text-danger">{{ $message }}</label>
                      @enderror
                      </div>
                     ...
                     <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="tanggal_lahir" placeholder="Tanggal Lahir Mahasiswa" value="{{$mahasiswa->tanggal_lahir}}">
                      @error('tanggal_lahir')
                      <label closs="text-danger">{{ $message }}</label>
                      @enderror
                    </div>
